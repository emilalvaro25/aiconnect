  ...
  return (
    <div className="transcription-container">
      <div className="transcription-view" ref={scrollRef}>
        {turns.map((t, i) => (
          ...
          >
            ...
            <div className="transcription-text-content">
              {t.imageUrl && <img src={t.imageUrl} alt="User upload" className="uploaded-image" />}
        ...
        {isAgentTyping && (
          <div className="transcription-entry agent">
            <div className="transcription-header">
              <div className="transcription-source">Kithai AI</div>
            </div>
            <div className="transcription-text-content">
